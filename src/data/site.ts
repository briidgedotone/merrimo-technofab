...
export const advantages = [
  {
    ...
    illustration: "civil" as const,
    alt: "Line drawing of an RCC foundation, industrial flooring bay and boundary wall on a site plan.",
  },
  {
    number: "02",
    eyebrow: "MEP",
    ...
    illustration: "mep" as const,
    alt: "Line drawing of a pipe rack carrying utility piping, cable trays and an HVAC duct run.",
  },
  {
    number: "03",
    eyebrow: "Fabrication",
    ...
    illustration: "fabrication" as const,
    alt: "Line drawing of a pre-engineered building frame with columns, rafters and purlins being erected.",
  },
];
...
export const pillars = [
  {
    ...
    illustration: "mechanical" as const,
    alt: "Isometric line drawing of a pump skid with suction and discharge piping on a base frame.",
  },
  {
    ...
    illustration: "electrical" as const,
    alt: "Isometric line drawing of a distribution panel feeding a ladder-type cable tray.",
  },
  {
    ...
    illustration: "plumbing" as const,
    alt: "Isometric line drawing of a water storage tank feeding a valved distribution manifold.",
  },
  {
    ...
    illustration: "rainwater" as const,
    alt: "Isometric line drawing of a roof gutter, down-take pipe, catch pit and recharge well.",
  },
  {
    title: "HVAC Ducting",
    ...
    illustration: "hvac" as const,
    alt: "Isometric line drawing of a rectangular duct run with an elbow, take-off and diffuser.",
  },
  {
    ...
    illustration: "installation" as const,
    alt: "Isometric line drawing of a tower crane lifting a steel beam into position.",
  },
  {
    ...
    illustration: "interior" as const,
    alt: "Isometric line drawing of partition framing beneath a suspended ceiling grid.",
  },
];
